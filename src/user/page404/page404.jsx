    ...
    <>
      ...
      <div className="bg-texture px-4">
        ...
        <main style={{ minHeight: "100vh" }} className="flex-grow flex items-center justify-center relative overflow-hidden py-12">
          ...
          <div 
            className="font-display select-none absolute text-[180px] md:text-[250px] lg:text-[300px] font-bold text-muted dark:text-gray-800 opacity-40 dark:opacity-20 z-0 pointer-events-none"
          >
            404
          </div>
