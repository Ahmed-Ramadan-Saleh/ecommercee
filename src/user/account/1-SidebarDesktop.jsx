...
const SidebarDesktop = ({ user }) => {
  ...
  return (
    <aside className="hidden lg:block lg:col-span-3">
      <div className="sticky top-24 bg-surface rounded-2xl border border-line shadow-sm overflow-hidden">
        {/* User */}
          ...
          {menuItems.map((item, index) => (
            <NavLink
              ...
              className={({ isActive }) =>
                ...
                ${
                  isActive
                    ? "bg-industrial-dark text-white shadow-sm"
        ...
        <div className="p-4 border-t border-line">
          <NavLink
            to="/signin"
            className="flex items-center gap-3 w-full px-4 py-2 text-industrial-red hover:bg-industrial-red/10 rounded-lg transition"
          >
            <svg
              className="w-5 h-5"
              fill="none"
