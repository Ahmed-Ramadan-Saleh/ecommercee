...
import "./home.css"; // Assuming CSS for animations (marquee, etc.) is here
...
const ProductCard = ({ product, index }) => (
  <div
    className="product-card group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl reveal"
  ...
  >
    <div className="relative aspect-[3/4] overflow-hidden bg-[#F0F0ED]">
      ...
      <button
        className="absolute top-3 right-3 w-10 h-10 bg-white/90 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 hover:bg-[#C45C3E] hover:text-white transition-all"
    ...
    <>
      ...
      <div className="bg-texture">
        ...
        <section className="relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 lg:order-1">
                <p
                  className="text-sm font-medium text-[#C45C3E] tracking-widest uppercase mb-4 animate-fade-up"
                ...
                >
                  FIND CLOTHES
                  <br />
                  <span className="text-[#C45C3E]">THAT MATCHES</span>
                  <br />
                  YOUR STYLE
                </h1>
                <p
                  className="text-[#8A8A8A] text-lg mb-8 max-w-md animate-fade-up"
                ...
                <div
                  className="flex gap-8 mt-12 pt-8 border-t border-[#E8E8E5] animate-fade-up"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#8A8A8A]">Premium Products</p>
                  </div>
                  <div>
                    <p className="font-display text-3xl lg:text-4xl font-bold">
                      30,000+
                    </p>
                    <p className="text-sm text-[#8A8A8A]">Happy Customers</p>
                  </div>
                </div>
              </div>
              ...
              <div className="order-1 lg:order-2 relative animate-fade-in">
                <div className="relative aspect-[4/5] rounded-3xl overflow-hidden bg-gradient-to-br from-[#E8E0D8] to-[#D4CCC4]">
                  ...
                  />
                  {/* Floating Cards */}
                  <div className="absolute -left-4 top-1/4 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg animate-float">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#C45C3E]/10 rounded-full flex items-center justify-center">
                        <svg
                          className="w-5 h-5 text-[#C45C3E]"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[#8A8A8A]">100% Authentic</p>
                      </div>
                    </div>
                  </div>
                  <div
                    className="absolute -right-4 bottom-1/4 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg animate-float"
                    style={{ animationDelay: "1s" }}
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#E5A54B]/10 rounded-full flex items-center justify-center">
                        <svg
                          className="w-5 h-5 text-[#E5A54B]"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                        >
                          <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
          ...
          {/* Brand Logos */}
          <div className="border-y border-[#E8E8E5] py-8">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-10 reveal">
              ...
              <Link
                to="/category"
                className="hidden sm:flex items-center gap-2 text-sm font-medium hover:text-[#C45C3E] transition-colors group"
              >
                View All
                <svg
        ...
        {/* Top Selling */}
        <section className="py-16 lg:py-24 bg-[#F0F0ED]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-10 reveal">
              <div>
                <h2 className="font-display text-3xl lg:text-4xl font-bold">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 reveal">
              ...
              <p className="text-[#8A8A8A] mt-2">Find your perfect look</p>
            </div>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              {STYLE_CATEGORIES.map((category, index) => {
                ...
                return (
                  <a
                    key={category.name}
                    href="#"
                    className={`style-card ${heights[index]} rounded-2xl overflow-hidden block reveal relative group`}
                    style={{ transitionDelay: `${index * 0.1}s` }}
                  >
                    <img
                      src={category.image}
              ...
              <div className="relative">
                ...
                >
                  <input
                    ...
                    className="flex-1 px-6 py-4 rounded-full bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:border-[#C45C3E] transition-colors"
